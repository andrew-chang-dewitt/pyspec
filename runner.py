...
class Expectations:
    ...
    class Equal:
        ...
        def run(self, actual):
            ...
            assert actual_res == self.expected, Expectations.err_msg(actual_res, self.expected)
    ...
    class Error:
        ...
        def run(self, actual):
            ...
            assert actual_res == self.exception_class, Expectations.err_msg(actual_res, self.exception_class)
